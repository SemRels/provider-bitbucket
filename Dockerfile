...
# SPDX-FileCopyrightText: 2026 The provider-bitbucket Authors
...
LABEL org.opencontainers.image.title="semrel-plugin-provider-bitbucket" \
      org.opencontainers.image.description="semrel plugin: provider-bitbucket" \
      org.opencontainers.image.url="https://semrel.io" \
      org.opencontainers.image.source="https://github.com/SemRels/provider-bitbucket" \
